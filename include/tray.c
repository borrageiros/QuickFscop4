...
void ShowContextMenu(HWND hwnd) {
  ...
  InsertMenu(menu_options, -1, MF_BYPOSITION|(ctrlaltf4_xkill?MF_CHECKED:0), (ctrlaltf4_xkill?SWM_CTRLALTF4XKILL_OFF:SWM_CTRLALTF4XKILL_ON), l10n.menu.ctrlaltf4_xkill);
